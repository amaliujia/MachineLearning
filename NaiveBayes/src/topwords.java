...
public class topwords {
    ...
    public static void main(String[]args){
        ...
        List<Map.Entry<String, Double>> folder = new ArrayList<Map.Entry<String, Double>>(naive.pMap2.entrySet());
        ...
        folder = new ArrayList<Map.Entry<String, Double>>(naive.pMap1.entrySet());
        Collections.sort(folder, new Comparator<Map.Entry<String, Double>>() {
            public int compare(Map.Entry<String, Double> e1,
                               Map.Entry<String, Double> e2) {
                if (!e1.getValue().equals(e2.getValue())) {
